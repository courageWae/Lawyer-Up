    ...
    <section id="main-content">
      <section class="wrapper">
        <div class="row">
          ...
          <div class="col-lg-12">
            <h3 class="page-header"><i class="fa fa-table"></i>Insurance Companies</h3>
            <ol class="breadcrumb">
              <li><i class="fa fa-home"></i><a href="{{ route('legal.home') }}">Home</a></li>
              <li><i class="fa fa-table"></i>Table</li>
              <li><i class="fa fa-th-list"></i>List of Insurance Companies</li>
            </ol>
          </div>
        </div>
        ...
        <div class="row">
          ...
          <div class="col-lg-6">
             <div class="jumbotron">
               <h1 class="display-4">Insurer Details</h1>
               <hr class="my-4">
               <h3>Full Name </h3>
               ...
               <div class="alert alert-info" role="alert" style="font-weight: bolder;color:black">
                ...
                <p class="lead">
                <a class="btn btn-primary btn-lg" href="{{ route('insurer.list') }}" role="button">back</a>
               </p>
            </div>
          </div>
          <div class="col-lg-3"> 
