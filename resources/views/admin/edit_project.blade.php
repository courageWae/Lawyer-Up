        ...
        <div class="row">
          <div class="col-lg-12">
            ...
            <ol class="breadcrumb">
              ...
              <li><i class="fa fa-file-text-o"></i>Edit Projects</li>
            </ol>
          </div>
        </div>
            ...
            <section class="panel">
              ...
              <div class="panel-body">
                <div class="form">
                  ...
                  <!-- Administrator Forms -->
                  <form class="form-validate form-horizontal" method="post" action="{{ route('admin.update.project',['project_alias'=>$project_alias->project_alias]) }}" enctype="multipart/form-data">
                    @csrf
                    @method('PATCH')
                    <div class="form-group ">
                      <label for="name" class="control-label col-lg-2"><strong>Project Name</strong></label>
                      <div class="col-lg-10">
                        <input class="form-control @error('name') is-invalid @enderror" name="name" type="text" value="{{ $project_alias->name }}" required/>
                          @error('name')
                   ...
                   <div class="form-group">
                      ...
                      <div class="col-lg-10">
                        <textarea class="form-control @error('content') is-invalid @enderror" id="summary-ckeditor" name="content">{{ $project_alias->content }}
                        </textarea>
                      </div>
                      @error('content')
                      <span class="invalid-feedback" role="alert">
                    ...
                    <div class="form-group ">
                      ...
                      <div class="col-lg-10">
                        <select class="form-control" name="status" type="text" required>
                          <option selected>{{ $project_alias->status }}</option>
                    ...
                    <div class="form-group ">
                      ...
                      <div class="col-lg-10">
                        <input class="form-control @error('date') is-invalid @enderror" name="date" type="date" value="{{ $project_alias->date }}" required/>
                        @error('date')
                        <span class="invalid-feedback" role="alert">
                          <strong>{{ $message }}</strong>
                        </span>
