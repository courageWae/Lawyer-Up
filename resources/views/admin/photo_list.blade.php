              ...
              <table class="table table-striped table-advance table-hover">
                <tbody>
                  ...
                  <tr>
                    ...
                    <td>
                      <a href="{{ asset('/uploads/pictures/user/'.$photo->photo) }}" target = "blank">
                        <img src ="{{ asset('/uploads/pictures/user/'.$photo->photo) }}" style="width:50px; height: 50px;">   
                      </a>
                    </td>
                    <td>{{ $photo->album->name }}</td>
                    <td>{{ $photo->created_at }}</td>
                    <td>
                      <a href="{{ route('admin.delete.photo',['photo'=>$photo->id]) }}" class="btn btn-danger delete-confirm">Delete</a>
                    </td>
