  ...
  <body>
    ...
    <main>
      <div id="details" class="clearfix">
        ...
        <div id="invoice">
          <h1> Invoice No:: {{count($invoice)+ 001}} </h1>
      ...
      <table border="0" cellspacing="0" cellpadding="0">
        ...
        <tbody>
          <tr>
            ...
            <td class="desc"><h3>PLAN</h3>{{ strtoupper($category->package->name) }}</td>
            <td class="unit">{{ strtoupper($category->name) }}</td>
            <td class="desc">&cent{{ $category->price }}</td>
            <td class="unit">1</td>
