...
<div class="page-wrapper">
    <div class="container">
        ...
        <div class="row justify-content-center">
            <div class="col-md-10">
            <div class="card">
                <div class="card-header" style="background-color: yellow;">{{ __('Add New Client') }}</div>
                ...
                <div class="card-body">
                    ...
                    <form method="POST" action="/adminAdd" enctype="multipart/form-data">
                        ...
                        <!-- PHOTO -->
                        <div class="form-group row">
                            <label for="photo" class="col-md-4 col-form-label text-md-right">Upload Picture</label>
                            <div class="col-md-6">
