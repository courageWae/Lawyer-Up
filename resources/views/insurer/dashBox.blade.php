  ...
  <ul class="list-group list-group-flush">
    ...
    <li class="list-group-item">
      <center>
        ...
        <a href="{{ route('insurer.list.client') }}">View Clients</a> 
      </center>
    </li>
    <li class="list-group-item">
      <center>
        ...
        <a href="{{ route('insurer.add.client')}}">Add Client</a>
      </center>
    </li>
    <li class="list-group-item">
      <center>
        ...
        <a href="{{ route('insurer.list.invoice') }}">View Invoices</a>  
      </center>
    </li>
     ...
     <li class="list-group-item">
      <center>
        <svg width="1em" height="1em" viewBox="0 0 16 16" class="bi bi-people" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
            ...
            <a href="{{ route('insurer.profile') }}">View Profile</a> 
      </center>
    </li>
    ...
    <li class="list-group-item">
      <center>
        <svg width="1em" height="1em" viewBox="0 0 16 16" class="bi bi-pencil-fill" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
            ...
            <a href="{{ route('insurer.show.profile',['insurer'=>Auth::user()->id]) }}">Edit Profile</a>  
      </center>
    </li>
