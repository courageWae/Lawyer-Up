  ...
  <ul class="list-group list-group-flush">
    <li class="list-group-item">
    	<center>
    		<a href="{{ asset('uploads/pictures/user/'. Auth::user()->photo ) }}" target="blank">
                <img class="card-img-top" src="{{ asset('uploads/pictures/user/'.Auth::user()->photo ) }}" alt="{{ asset('assets/images/holder.png') }}" width="60" height="60" style="border-radius: 20px;">
    ...
    <li class="list-group-item">
    	<center>
    		...
    		<a href="{{ route('user.dashboard') }}">My Packages</a>
    	</center>
    </li>
    <li class="list-group-item">
    	<center>
            ...
            <a href="{{ route('user.appointments') }}"> My Appointments</a>	
    	</center>
    </li>
    <li class="list-group-item">
    	<center>
